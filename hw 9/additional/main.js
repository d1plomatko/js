...
function divCreator(item, child,father){
    ...
    for (let itemKey in item) {
        ...
        if (typeof item[itemKey] !== 'object') {
            ...
            userObject.classList.add('user-object');

            let h4 = document.createElement('h4');
            h4.innerText = itemKey.toUpperCase();
            userObject.appendChild(h4);

            divCreator(item[itemKey], userObject, child);
...
for (let usersListElement of usersList) {
    ...
    h3.innerText = `User ${usersListElement.id}`;
    userCard.appendChild(h3);

    divCreator(usersListElement, userCard, wrapper);
